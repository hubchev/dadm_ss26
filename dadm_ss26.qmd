...
- Quarto files of your handout and presentation.
- HTML files of your handout and presentation.
- PDF files of your handout and presentation.
...
Please consider @tbl-tpc. You should be able to identify yourself with your first name.

::: {.callout-important appearance="default"}
- If you do not see your name  on the list but have registered, please contact me as soon as possible.

- The presentation day is an official examination day, and failure to attend will result in a grade of 5.0. Ensure that you do not miss this important date.
:::
...
| May 5     | Roopam      | Coding and Collaborating with GitHub                                                                       |
...
| May 26    | Adineh      | Conducting Multiple Linear Regression Analysis Using R                                      |
| June 2    | Amine       | Interactive Visualization in R & Applications in Business                                                  |
| June 2    | Vedat       | Geospatial Visualization with R                                                                            |
| June 2    | Mustafa     | Decision Making with Sentiment Analysis in R                                                               |
| June 2    | Sukanya     | R Packages for Importing Data Directly from the Internet                                                             |
...
| June 16   | Mohammed    | Presenting Regression Results Using R                                        |
